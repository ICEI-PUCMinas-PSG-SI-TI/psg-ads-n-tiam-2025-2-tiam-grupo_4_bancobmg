...
| ----------------------------------------------- | ----- | ----- | ----- | ----- | ----- | ----- | ----- | ----- | ------ | ------ | ------ | ------ |
| **RF-01 – Cadastro de Cliente com CPF**         | X     |       |       |       |       |       |       |       | X      | X      |        | X      |
| **RF-02 – Escolha da Conta para Saque**         |       | X     |       |       |       |       |       |       | X      | X      |        | X      |
| **RF-03 – Consulta de Autorização**             |       |       | X     | X     |       |       |       |       | X      |        |        | X      |
| **RF-04 – Liberação de FGTS**                   |       |       | X     | X     |       |       |       |       | X      |        |        | X      |
